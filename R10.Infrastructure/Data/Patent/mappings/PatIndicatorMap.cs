...
namespace R10.Infrastructure.Data.Patent.mappings
{
    public class PatIndicatorMap : IEntityTypeConfiguration<PatIndicator>
    {
        public void Configure(EntityTypeBuilder<PatIndicator> builder)
        {
            ...
            builder.HasMany(i => i.DueDates).WithOne(d => d.PatIndicator).HasForeignKey(d => d.Indicator).HasPrincipalKey(i => i.Indicator);
            builder.HasMany(i => i.DueDateInvs).WithOne(d => d.PatIndicator).HasForeignKey(d => d.Indicator).HasPrincipalKey(i => i.Indicator);
        }
    }
}
