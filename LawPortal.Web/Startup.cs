...
using LawPortal.Web.MiddleWares;
...
namespace LawPortal.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddHostedService<LawPortal.Web.Services.Menu.AuxiliaryMenuSeeder>();
            ...
            services.AddMvc(options =>
            {
                ...
                .AddJsonOptions(options =>
                {
                    ...
                    options.JsonSerializerOptions.Converters.Add(new LawPortal.Web.Helpers.NullableDateTimeConverter());
                })
