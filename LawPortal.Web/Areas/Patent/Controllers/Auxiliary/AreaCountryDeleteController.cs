...
namespace LawPortal.Web.Areas.Patent.Controllers
{
    ...
    public class AreaCountryDeleteController : BaseController
    {
        ...
        public async Task<IActionResult> PageRead([DataSourceRequest] DataSourceRequest request, List<QueryFilterViewModel> mainSearchFilters)
        {
            ...
            return Json(data.ToNavigableDataSourceResult(request, "areaCode:Area", "country:Country", "areaNewCode:AreaNew", "countryNew:CountryNew", "systems:Systems"));
        }
        ...
        {
            return await GetPicklistData(_repository.PatAreaCountryDeletes.AsNoTracking(), request, property, text, filterType, requiredRelation);
        }
