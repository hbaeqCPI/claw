...
// R10.MdbReader - 32-bit console app for reading MDB files and outputting JSON
// Usage: R10.MdbReader.exe <mdbPath1> [mdbPath2]
// Outputs JSON to stdout: { "file1": { "tableName": [ {row}, ... ], ... }, "file2": { ... } }

if (args.Length < 1)
{
    Console.Error.WriteLine("Usage: R10.MdbReader.exe <mdbPath1> [mdbPath2]");
    return 1;
}
