...
namespace R10.Web.Areas.Patent.Controllers
{
    ...
    public class DesCaseTypeFieldsController : BaseController
    {
        ...
        private readonly IViewModelService<PatDesCaseTypeFields> _viewModelService;
        private readonly IEntityService<PatDesCaseTypeFields> _auxService;
        ...
        public DesCaseTypeFieldsController(
            ...
            IViewModelService<PatDesCaseTypeFields> viewModelService,
            IEntityService<PatDesCaseTypeFields> auxService,
        ...
        private async Task<DetailPageViewModel<PatDesCaseTypeFields>> PrepareEditScreen(int id)
        {
            var viewModel = new DetailPageViewModel<PatDesCaseTypeFields>
            {
        ...
        public async Task<IActionResult> Detail(int id, bool singleRecord = false, bool fromSearch = false)
        {
            ...
            PatDesCaseTypeFields detail = page.Detail;
        ...
        private async Task<DetailPageViewModel<PatDesCaseTypeFields>> PrepareAddScreen()
        {
            var viewModel = new DetailPageViewModel<PatDesCaseTypeFields>
            {
                Detail = new PatDesCaseTypeFields()
            };
        ...
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Save([FromBody] PatDesCaseTypeFields desCaseTypeFields)
        {
            if (ModelState.IsValid)
            {
        ...
        private async Task<PatDesCaseTypeFields> GetById(int id)
        {
        ...
        private async Task ExtractCopyParams(DetailPageViewModel<PatDesCaseTypeFields> page)
        {
