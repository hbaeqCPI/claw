...
{
    public class PatImageCostViewModelService : IPatImageCostViewModelService
    {
        private readonly ISystemSettings<PatSetting> _settings;
        private readonly IDocumentService _docService;
        private readonly ClaimsPrincipal _user;

        public PatImageCostViewModelService(
        ...
        public async Task<List<DocDocumentListViewModel>> CreateViewModelForList(int parentId)
        {
            ...
            var docs = await _docService.DocDocuments.Where(d => _docService.DocFolders.Where(f => f.SystemType == SystemTypeCode.Patent && f.DataKey == "CostTrackId" && f.DataKeyValue == parentId)
