...
{
    public class TmkImageCostViewModelService : ITmkImageCostViewModelService
    {
        private readonly ISystemSettings<TmkSetting> _settings;
        private readonly IDocumentService _docService;
        private readonly ClaimsPrincipal _user;

        public TmkImageCostViewModelService(
        ...
        public async Task<List<DocDocumentListViewModel>> CreateViewModelForList(int parentId)
        {
            ...
            var docs = await _docService.DocDocuments.Where(d => _docService.DocFolders.Where(f => f.SystemType == SystemTypeCode.Trademark && f.DataKey == "CostTrackId" && f.DataKeyValue == parentId)
