...
namespace R10.Web.Areas.Trademark.Controllers
{
    ...
    public class DesCaseTypeDeleteExtController : BaseController
    {
        ...
        {
            var entities = _repository.TmkDesCaseTypeDeleteExts.AsNoTracking().AsQueryable();
        ...
        {
            var detail = await _repository.TmkDesCaseTypeDeleteExts.AsNoTracking()
        ...
        {
            var data = new TmkDesCaseTypeDeleteExt { IsNewRecord = true };
        ...
        public async Task<IActionResult> Save([FromBody] TmkDesCaseTypeDeleteExt entity)
        {
            ...
            {
                await _repository.Database.ExecuteSqlRawAsync(
                    @"INSERT INTO tblTmkDesCaseTypeDelete_Ext (IntlCode, CaseType, DesCountry, DesCaseType, [Default], IntlCodeNew, CaseTypeNew, DesCountryNew, DesCaseTypeNew, Systems)
        ...
        {
            return await GetPicklistData(_repository.TmkDesCaseTypeDeleteExts.AsNoTracking(), request, property, text, filterType, requiredRelation);
        }
