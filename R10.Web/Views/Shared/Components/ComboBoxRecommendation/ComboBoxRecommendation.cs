...
{
    public class ComboBoxRecommendation : ViewComponent
    {
                                           ...
                                           int listWidth = 300, bool showLinkButton = false)
        {
            ...
            var model = new ComboBoxOptions
            {
                ...
                ListWidth = listWidth,
                LinkButtonUrl = showLinkButton ? Url.Action("DetailLink", "DMSRecommendation", new { Area = "DMS", Recommendation = "actualValue" }) : ""
            };
