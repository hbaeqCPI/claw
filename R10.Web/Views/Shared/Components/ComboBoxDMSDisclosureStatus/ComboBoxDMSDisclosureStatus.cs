...
{
    public class ComboBoxDMSDisclosureStatus : ViewComponent
    {
                                           ...
                                           int listWidth = 300, bool showLinkButton = false)
        {
            ...
            var model = new ComboBoxOptions
            {
                ...
                Controller = string.IsNullOrEmpty(controller) ? "DMSDisclosureStatus" : controller,
                ...
                ListWidth = listWidth,
                LinkButtonUrl = showLinkButton ? Url.Action("DetailLink", "DMSDisclosureStatus", new { Area = "DMS", DisclosureStatus = "actualValue" }) : ""
            };
