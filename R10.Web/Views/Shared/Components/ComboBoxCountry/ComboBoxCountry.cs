...
{
    public class ComboBoxCountry : ViewComponent
    {
        ...
        public IViewComponentResult Invoke(string name, string textProperty, string valueProperty, string system, 
                                           ...
                                           bool showLinkButton=false, string onChange="", string data = "", string onOpen = "", bool required=false)
        {
            ...
            model.LinkButtonUrl = showLinkButton ? Url.Action("DetailLink", model.Controller, new { Area = model.Area, country = "actualValue" }) : "";
            return View(model);
        }
    }
