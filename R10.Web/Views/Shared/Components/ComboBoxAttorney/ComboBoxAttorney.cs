...
{
    public class ComboBoxAttorney : ViewComponent
    {
                                           ...
                                           int listWidth = 300, bool showLinkButton = false, bool limitToList = true)
        {
            ...
            var model = new ComboBoxOptions
            {
                ...
                Controller = string.IsNullOrEmpty(controller) ? "Attorney" : controller,
                Action = string.IsNullOrEmpty(action) ? "GetAttorneysList" : action,
                ...
                ListWidth = listWidth,
                LinkButtonUrl = showLinkButton ? Url.Action("DetailLink", "Attorney", new { Area = "Shared", attorneyId = "actualValue" }) : "",
