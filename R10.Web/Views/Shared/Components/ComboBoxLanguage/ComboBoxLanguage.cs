...
{
    public class ComboBoxLanguage : ViewComponent
    {
                                           ...
                                           int listWidth = 300, bool showLinkButton = false)
        {
            ...
            var model = new ComboBoxOptions
            {
                ...
                Controller = string.IsNullOrEmpty(controller) ? "Language" : controller,
                Action = string.IsNullOrEmpty(action) ? "GetLanguageList" : action,
                ...
                ListWidth = listWidth,
                LinkButtonUrl = showLinkButton ? Url.Action("DetailLink", "Language", new { Area = "Shared", Language = "actualValue" }) : ""
            };
