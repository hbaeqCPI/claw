...
export default class PatActionDuePage extends ActivePage {
    ...
    init(addMode, parentId, pageId, isSharePointIntegrationOn) {
        ...
        this.appInfo = [{ CaseNumber: "", Country: "", SubCase: "", CaseType: "", ApplicationStatus: "", AppNumber: "", FilDate: "" }];
        this.tabsLoaded = [];
        ...
        $(document).ready(()=> {
            ...
            $("#actionDueDetail-Content").on("click", "input[name='CheckDocket']", function () {
                ...
                const showVerifyAction = parent.find(".CheckDocketDiv").data("show-verify-action");
