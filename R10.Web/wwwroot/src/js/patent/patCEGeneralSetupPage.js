...
export default class PatCEGeneralSetup extends ActivePage {
    ...
    tabChangeSetListener = () => {
        const self = this;
        $('#patCEGeneralSetup-tab a').on('click',
            (e) => {
                e.preventDefault();
    ...
    showCopyScreen() {
        ...
        const dialogContainer = popupContainer.find("#patCEGeneralSetupCopyDialog");
