...
export default class PacWorkflow extends ActivePage {
    ...
    initialize = (screen, id) => {
        this.editableGrids = [            
            { name: "pacWorkflowActionGrid", filter: { parentId: id }, afterSubmit: this.updateRecordStamps }           
        ];
    ...
    tabChangeSetListener = () => {
        ...
        $(document).ready(function() {
            const actionsGrid = $("#pacWorkflowActionGrid");
            ...
            actionsGrid.on("click", ".attachment-filter-marker", (e) => {
                ...
                const url = `${baseUrl}/PatClearance/Workflow/AttachmentFilterLoad`;
    ...
    actionTypeOnChange = (e) => {
        if (e.item) {
            ...
            const grid = $("#pacWorkflowActionGrid").data("kendoGrid");
    ...
    getActionType = (e) => {
        var grid = $("#pacWorkflowActionGrid").data("kendoGrid");
