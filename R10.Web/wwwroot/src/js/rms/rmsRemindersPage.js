...
export default class RMSRemindersPage extends ActivePage {
    ...
    searchResultGridDataBound = (e) => {
        ...
        if (data.length > 0) {
            ...
            for (var i = 0; i < rows.length; i++) {
                ...
                if (grid.closest("form").data("preview-email-url") && (rowData.ReceiveRMSReminder || rowData.ReceiveRMSReminderReport))
                    previewEmail.show();
                else
                    previewEmail.hide();
    ...
    openPortfolioreview = (e) => {
        ...
        if (url) {
            ...
            filters.push({
                property: "TmkTrademark.Client.ClientCode",
                operator: "",
    ...
    previewReport(e) {
        ...
        const searchCriteriaTab = searchResultsContainer.find("#rmsRemindersSearchMainTabContent");
        ...
        if (url) {
            ...
            $.post(url, data)
                .done(function (result) {
                    ...
                    if (item.ReceiveRMSReminder || item.ReceiveRMSReminderReport)
                        previewEmail.show();
                    else
                        previewEmail.hide();
