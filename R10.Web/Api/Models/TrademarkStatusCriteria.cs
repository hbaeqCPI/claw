...
{
    public class TrademarkStatusCriteria : ApiCriteria
    {
        ...
        public override List<QueryFilterViewModel> ToQueryFilter()
        {
            ...
            if (!string.IsNullOrEmpty(TrademarkStatus))
                filters.Add(new QueryFilterViewModel() { Property = "TrademarkStatus", Value = TrademarkStatus });
