...
// 32-bit Access database generator. Reads from SQL Server, writes per-system MDBs.
// Usage: LawPortal.Mdb.exe generate <configJsonPath>
// Config JSON: { "SqlConnectionString", "TemplatePath", "OutputFolder", "Systems",
//                "GeneratePatent", "GenerateTrademark", "ReleaseName" }
internal static class Generator
{
    public static async Task<int> Run(string[] args)
    {
        if (args.Length < 1)
        {
            Console.Error.WriteLine("Usage: LawPortal.Mdb.exe generate <configJsonPath>");
            return 1;
        }
