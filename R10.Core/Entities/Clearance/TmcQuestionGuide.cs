...
{
    public class TmcQuestionGuide : BaseEntity
    {
        [Key]
        ...
        public TmcQuestionGroup? TmcQuestionGroup { get; set; }

        public List<TmcQuestion>? TmcQuestions { get; set; }
        public List<TmcQuestionGuideChild>? TmcQuestionGuideChildren { get; set; }
