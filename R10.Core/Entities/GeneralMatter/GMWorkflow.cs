...
{
    public class GMWorkflow : BaseEntity
    {
        [Key]
        ...
        public string? MatterTypeFilter { get; set; }
        ...
        [NotMapped]
        public string[]? MatterTypeFilterList { get; set; }
        [NotMapped]
        public string[]? RespOfficeFilterList { get; set; }

        public List<GMWorkflowAction>? WorkflowActions { get; set; }
        public SystemScreen? SystemScreen { get; set; }
        public List<GMWorkflowActionParameter>? WorkflowActionParameters { get; set; }

        [NotMapped]
        public string? CopyOptions { get; set; }
    }

    public enum GMWorkflowTriggerType
    {
