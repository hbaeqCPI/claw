...
{
    public class TmkWorkflow : BaseEntity
    {
        [Key]
        ...
        public List<TmkWorkflowAction>? WorkflowActions { get; set; }
        public SystemScreen? SystemScreen { get; set; }
        public List<TmkWorkflowActionParameter>? WorkflowActionParameters { get; set; }

        [NotMapped]
        public string? CopyOptions { get; set; }
    }

    public enum TmkWorkflowTriggerType
    {
