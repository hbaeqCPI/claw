...
{
    public class FFSetting : DefaultSetting
    {
        //CHECKBOX DEFAULTS
        //instructions
        ...
        public string ReminderCoverLetter { get; set; } = "Foreign Filing Reminder";               //Default reminder cover letter
        public string ClientConfirmationCoverLetter { get; set; } = "Foreign Filing Confirmation"; //Default client confirmation cover letter
        public string AgentConfirmationCoverLetter { get; set; } = "Foreign Filing Agent Responsibility";  //Default agent responsibilty confirmation cover letter

        //NOTIFICATION EMAIL SETUP NAMES
        public string InstructionNotification { get; set; } = "Foreign Filing Instruction Notification";                   //Instruction notification email
        public string ClearedInstructionNotification { get; set; } = "Cleared Foreign Filing Instruction Notification";    //Blank instruction notification email
